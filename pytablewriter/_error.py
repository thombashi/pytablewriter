...
class EmptyTableNameError(Exception):
    """
    Exception raised when a table writer class of the |table_name| attribute is null
...
class EmptyHeaderError(Exception):
    """
    Exception raised when a table writer class of the |header_list| attribute is null
...
class EmptyValueError(Exception):
    """
    Exception raised when a table writer class of the |value_matrix| attribute is null
...
class EmptyTableDataError(Exception):
    """
    Exception raised when a table writer class of the |header_list| and |value_matrix|
    attributes are null
    """
